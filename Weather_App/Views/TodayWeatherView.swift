...
struct TodayWeatherView: View {
    ...
    var body: some View {
        ...
        .background(RoundedRectangle(cornerRadius: 20).fill(LinearGradient(gradient: Gradient(colors: [Color.blue.opacity(0.5), Color.pink]), startPoint: .top, endPoint: .bottom)).opacity(0.3))
